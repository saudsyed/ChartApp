...
final class SalesViewModel: ObservableObject {
    ...
    var averageSales: Double {
        ...
        return calculateAverage(salesData: salesData) ?? 0
    }
    ...
    //MARK: - changedBookSales()
    func changedBookSales(percentage: Double) -> String? {
